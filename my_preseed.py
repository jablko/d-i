...
'''.format(
  ...
  zeal_command = [
      ...
      'wget -O - kapeli.com/feeds/CSS.tgz | tar xz',
      'wget -O - kapeli.com/feeds/Emacs_Lisp.tgz | tar xz',
      'wget -O - kapeli.com/feeds/Haskell.tgz | tar xz',
      'wget -O - kapeli.com/feeds/HTML.tgz | tar xz',
      'wget -O - kapeli.com/feeds/JavaScript.tgz | tar xz',
      'wget -O - kapeli.com/feeds/MySQL.tgz | tar xz',
      'wget -O - kapeli.com/feeds/PHP.tgz | tar xz',
      'wget -O - kapeli.com/feeds/Python_3.tgz | tar xz',
      'wget -O - kapeli.com/feeds/Vim.tgz | tar xz',
  ]
...
"'''.format(' \\\n  '.join(
  ...
  late_command = CommandSequence([
      ...
      #),
      #r'''echo -e '\#<property .*/># d;\#</property># i \\\n    <property name="show-tray-icon" type="int" value="1"/>\\\n    <property name="sleep-button-action" type="uint" value="1"/>\\\n    <property name="hibernate-button-action" type="uint" value="2"/>\\\n    <property name="critical-power-action" type="uint" value="2"/>' | sed -f - -i /target/home/nottheoilrig/.config/xfce4/xfconf/xfce-perchannel-xml/xfce4-power-manager.xml''',
      'in-target su nottheoilrig byobu-ctrl-a screen',
      'in-target su nottheoilrig byobu-keybindings',
      Install(
      ...
      *zeal_command,
      ...
      'XDG_CONFIG_HOME=/home/nottheoilrig/.config in-target su nottheoilrig byobu-enable',
      ...
      *ftplugin_command,
      r''' \
  in-target su nottheoilrig vim-addons install \
    nerd-commenter \
    youcompleteme \
  ''',
      ...
      #'wget -O - cdist2.perforce.com/perforce/r15.2/bin.linux26x86_64/p4v.tgz | tar xz',
      #'chown -R 1000:1000 /target/home/nottheoilrig/p4v-2015.2.1458499',
      'in-target su nottheoilrig git config --global branch.autoSetupRebase always',
      'in-target su nottheoilrig git config --global pager.status true',
      "in-target su nottheoilrig git config --global pager.log 'perl /usr/share/doc/git/contrib/diff-highlight/diff-highlight | less'",
      "in-target su nottheoilrig git config --global pager.show 'perl /usr/share/doc/git/contrib/diff-highlight/diff-highlight | less'",
      "in-target su nottheoilrig git config --global pager.diff 'perl /usr/share/doc/git/contrib/diff-highlight/diff-highlight | less'",
      "in-target su nottheoilrig git config --global interactive.diffFilter 'perl /usr/share/doc/git/contrib/diff-highlight/diff-highlight'",
      #'in-target su nottheoilrig git config --global diff.compactionHeuristic true',
      'in-target su nottheoilrig git config --global credentials.helper store',
      #'> /target/home/nottheoilrig/.git-credentials',
      #'chown 1000:1000 /target/home/nottheoilrig/.git-credentials',
      #'wget -O /target/home/nottheoilrig/.hgrc nottheoilrig.com/d-i/hgrc',
      ...
      'cd /tmp',
      'wget languagetool.org/download/LanguageTool-stable.zip',
      'unzip -d /target/home/nottheoilrig /tmp/LanguageTool-stable',
      'chown -R 1000:1000 /target/home/nottheoilrig/LanguageTool-3.9',
      'cd /target/home/nottheoilrig',
      'in-target su nottheoilrig git clone https://github.com/mhayashi1120/Emacs-langtool.git',
      #
      *pbuilder_command,
      #
      Sed(
